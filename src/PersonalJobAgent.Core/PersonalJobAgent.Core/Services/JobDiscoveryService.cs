...
namespace PersonalJobAgent.Core.Services
{
    public class JobDiscoveryService : IJobDiscoveryService
    {
        ...
        public async Task<SavedSearch> CreateSavedSearchAsync(int userProfileId, string[] keywords, string location = null, string name = null)
        {
            ...
            var savedSearch = new SavedSearch
            {
                ...
                Keywords = keywords,
                Location = location,
                Name = name ?? $"Search for {string.Join(", ", keywords)}",
                CreatedDate = DateTime.Now
            };

            // Return the saved search (in a real implementation, this would be saved to the database)
